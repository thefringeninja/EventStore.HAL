...
namespace EventStore.HAL {
	internal static class EventStoreHALBrowserMiddleware {
		public static IApplicationBuilder UseEventStoreHALBrowser(
		...
		private static async Task ForwardToClientDevServer(
			...
			foreach (var (key, value) in headers) {
				context.Response.Headers.Add(key, new StringValues(value.ToArray()));
			}
